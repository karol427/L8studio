...
export default function Topbar({ pageTitle }) {
  const { user: appUser, darkMode, toggleDarkMode, colorScheme, changeScheme, COLOR_SCHEMES } = useApp()
    ...
    <header className="topbar">
      ...
      <div className="topbar-right">
        ...
        <div className="topbar-user">
          <span>Witaj, {authUser?.displayName || authUser?.email || appUser?.name}</span>
        </div>
        <button className="topbar-icon-btn topbar-logout" title="Wyloguj" onClick={logout}>
